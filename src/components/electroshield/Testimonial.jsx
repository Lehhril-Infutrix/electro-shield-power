...
const testimonials = [
  {
    ...
    quote:
      "Electroshield Power Industries delivered exceptional transformer components that exceeded our expectations in quality and reliability. Their oil immersed internal circuit breakers and CNC-cut laminations were flawless.",
    name: "Ravi Sharma",
    location: "Mumbai",
  },
  {
